    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors(AbstractHttpConfigurer::disable)
                ...
                auth -> auth
                        ...
                        .requestMatchers("/typeOfLostItem").permitAll()
                        .requestMatchers("/finding","/finding/byId","/finding/count","/finding/static","/finding/all","/finding/post", "/finding/admin","/finding/patch","/finding/adminS").permitAll()
                        .requestMatchers("/LostOrFound").permitAll()
